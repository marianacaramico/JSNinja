(function(){
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Mariana Caramico'));
  ...
  */
  ...
  var frase = text.match(/O Centauro de Luvas/gi).toString();
  console.log(text.replace(frase, frase.toUpperCase()));
