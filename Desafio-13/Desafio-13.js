...
*/
var nordeste = ['Bahia', 'Maranhão', 'Pernambuco', 'Piauí', 'Ceará', 'Sergipe', 'Paraíba', 'Rio Grande do Norte', 'Alagoas'];
...
var todosMais7 = brasil.every(function(item){
	return item.length > 7;
});
console.log(todosMais7 ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
