(function(){
    ...
    */
    ...
    console.log(sum(function(a,b){ return a+b; })); //5
    ...
    */
    var sub = calculator(7,2);

    var mult = calculator(8,4);

    var divi = calculator(10,4);

    var modu = calculator(5,3);
    ...
    */
    ...
    console.log(sub(function(a,b){ return a - b })); //5

    console.log( 'O resultado da multiplicação é:' );
    console.log(mult(function(a,b){ return a * b })); //32

    console.log( 'O resultado da divisão é:' );
    console.log(divi(function(a,b){ return a / b })); //2.5

    console.log( 'O resto da divisão é:' );
    console.log(modu(function(a,b){ return a % b })); //2
